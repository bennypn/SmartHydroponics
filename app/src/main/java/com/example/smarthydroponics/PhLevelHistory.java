...
public class PhLevelHistory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_phlevel_history);

        btnInfo = findViewById(R.id.btn_information8);
        btnHome = findViewById(R.id.btn_home8);
        btnProfil = findViewById(R.id.btn_profile8);
        ...
        recyclerView = findViewById(R.id.rc8);
        ...
        btnHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent;
                intent = new Intent(PhLevelHistory.this,
                        MainActivity.class);
    ...
    private void filterAndSortData(int year, int month, int day) {
        ...
        DatabaseReference historyRef = FirebaseDatabase.getInstance().getReference("history/phLevel");
        historyRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Log.d("PhLevelHistory", "Jumlah data [originalTableItemList]: " + originalTableItemList.size());
                Log.d("PhLevelHistory", "Jumlah data [filteredTableItemList]: " + filteredTableItemList.size());

                if (filteredTableItemList.isEmpty()) {
                    Toast.makeText(PhLevelHistory.this, "Data tidak ada di database", Toast.LENGTH_SHORT).show();
                }
