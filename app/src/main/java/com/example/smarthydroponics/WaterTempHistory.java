...
public class WaterTempHistory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_watertemp_history);

        btnInfo = findViewById(R.id.btn_information7);
        btnHome = findViewById(R.id.btn_home7);
        btnProfil = findViewById(R.id.btn_profile7);
        Button btnBack = findViewById(R.id.btn_back7);
        ...
        recyclerView = findViewById(R.id.rc7);
        ...
        btnHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent;
                intent = new Intent(WaterTempHistory.this,
                        MainActivity.class);
    ...
    private void filterAndSortData(int year, int month, int day) {
        ...
        DatabaseReference historyRef = FirebaseDatabase.getInstance().getReference("history/waterTemp");
        historyRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Log.d("WaterTempHistory", "Jumlah data [originalTableItemList]: " + originalTableItemList.size());
                Log.d("WaterTempHistory", "Jumlah data [filteredTableItemList]: " + filteredTableItemList.size());

                if (filteredTableItemList.isEmpty()) {
                    Toast.makeText(WaterTempHistory.this, "Data tidak ada di database", Toast.LENGTH_SHORT).show();
                }
